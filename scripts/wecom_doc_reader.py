...
用法（CLI）:
  python3 wecom_doc_reader.py --state-dir ./states login <user_id>
  python3 wecom_doc_reader.py --state-dir ./states check <user_id>
  python3 wecom_doc_reader.py --state-dir ./states read <user_id> <url>
  python3 wecom_doc_reader.py --state-dir ./states list-users
  python3 wecom_doc_reader.py --state-dir ./states remove-user <user_id>
